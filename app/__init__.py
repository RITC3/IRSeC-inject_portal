...
app_admin.add_view(admin.InjectExtensionModelView(models.InjectExtension, db.session))
app_admin.add_view(admin.InjectFileAdmin(os.path.join(basedir, "app", "injects"), '/injects/', name="Inject Files"))
app_admin.add_view(admin.AnnouncementModelView(models.Announcement, db.session))
